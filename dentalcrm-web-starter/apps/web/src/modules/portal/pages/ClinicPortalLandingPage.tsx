          ...
          <div className="flex flex-col gap-6 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-3xl">
              ...
              <h1 className="mt-5 text-5xl leading-tight text-white md:text-6xl">
                {clinicSettings?.website?.hero_title || clinicSettings?.brand_name || 'Clinica dental'}
              </h1>
              <p className="mt-4 text-base leading-8 text-white/76">
                {clinicSettings?.website?.hero_copy || 'Pide cita, revisa tus documentos y accede a tu area privada desde la misma web de la clinica.'}
              </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[1.6rem] border border-white/10 bg-white/8 p-5">
                ...
                <p className="mt-2 text-lg font-semibold text-white">
                  {clinicSettings?.public_phone || clinicSettings?.public_email || 'Consulta online disponible'}
                </p>
              </div>
              <div className="rounded-[1.6rem] border border-white/10 bg-white/8 p-5">
          ...
          <div className="panel rounded-[2rem] p-6">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {featuredTreatments.length === 0 && (
                <p className="text-sm text-slate-500">La clinica aun no ha publicado tratamientos en esta web.</p>
              )}
