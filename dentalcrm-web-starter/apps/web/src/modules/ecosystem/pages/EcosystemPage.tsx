...
export function EcosystemPage() {
  ...
  return (
    <section className="space-y-6">
      <div>
        <p className="text-sm font-medium text-[var(--color-brand)]">Conexiones</p>
              ...
              <div key={integration.provider} className="rounded-2xl border border-slate-200 p-4">
                ...
                <div className="mt-4 grid gap-4">
                  ...
                  {integrationErrors[integration.provider] && (
                    <p className="text-sm text-rose-600">{integrationErrors[integration.provider]}</p>
                  )}
                  <button
                    type="button"
      ...
      <div>
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="rounded-xl bg-[var(--color-brand)] px-4 py-2 text-xs font-semibold text-white hover:bg-[var(--color-brand-dark)] disabled:bg-slate-200 disabled:text-slate-400"
                >
        ...
        <div className="mt-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            ...
            <a href="#" className="font-semibold text-[var(--color-brand)] hover:underline">
...
const MARKETPLACE_ADDONS = [
  {
    ...
    icon: '🦷',
    description: 'Sincroniza escaneos intraorales 3Shape directamente con la ficha del paciente en MaxilArt.',
    price: '29€/mes',
    available: false,
  },
  {
  ...
  },
  {
    ...
    icon: '😁',
    description: 'Accede al portal de Invisalign desde MaxilArt, con seguimiento de casos y aprobaciones.',
    price: 'Gratuito',
    available: false,
  },
  {
