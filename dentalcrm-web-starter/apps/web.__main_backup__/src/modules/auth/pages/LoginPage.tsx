...
import { DEFAULT_CLINIC_BRAND, DEFAULT_CLINIC_EMAIL } from '@/shared/clinic/defaults';
...
const featureCards = [
  ...
  },
  {
    ...
    description: 'Mensajes, documentos y reserva online conectados con MaxilArt.',
  },
];
      ...
      <div className="grid min-h-[calc(100vh-1.5rem)] w-full gap-6 lg:grid-cols-[1.18fr_0.82fr]">
        <div className="panel-dark page-hero flex overflow-hidden rounded-[2.25rem] p-7 md:p-10">
          <div className="my-auto max-w-3xl">
            <span className="pill border-white/12 bg-white/10 text-white/80">{DEFAULT_CLINIC_BRAND}</span>
            <h1 className="mt-5 text-5xl leading-tight text-white md:text-6xl">
              Operacion diaria de {DEFAULT_CLINIC_BRAND}.
            </h1>
            <p className="mt-5 max-w-xl text-base leading-8 text-white/72">
              Entra para revisar la agenda, atender pacientes y coordinar cobros, consentimientos y seguimiento clinico.
            </p>
